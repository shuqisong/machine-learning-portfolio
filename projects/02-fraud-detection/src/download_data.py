"""
Download the Credit Card Fraud Detection dataset from Kaggle into data/raw/.

This dataset (mlg-ulb/creditcardfraud) contains 284,807 European credit card
transactions made over two days in September 2013, with 492 labeled as fraud
(0.17% of all transactions). It's the classic teaching dataset for imbalanced
binary classification: most features (V1-V28) are PCA-anonymized for privacy,
plus `Time`, `Amount`, and the `Class` label (1 = fraud).
